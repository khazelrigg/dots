...
theme.bg_systray    = xcolors.background

theme.fg_normal     = xcolors.color15
theme.fg_focus      = xcolors.color7
theme.fg_urgent     = xcolors.color2
theme.fg_minimize   = xcolors.color15

theme.useless_gap   = dpi(8)
theme.border_width  = dpi(4)
theme.border_normal = xcolors.color8
